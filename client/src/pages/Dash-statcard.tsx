...
export function StatCard({
  ...
  return (
    <Card
      className={cn(statCardVariants({ highlight }), "relative", className)}
    >
      ...
      {progress && (
        ...
        >
          <div className={cn("absolute inset-0 w-full h-full", progress.color)}>
            ...
            <div
              className="absolute top-0 left-0 right-0 h-[2px] bg-white/15"
              style={{
            ...
            />
            <div
              className="absolute top-[4px] left-0 right-0 h-[1px] bg-white/10"
              style={{
                animation: "professionalWave 4s ease-in-out infinite",
                animationDelay: "1s",
              }}
