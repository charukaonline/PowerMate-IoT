        ...
        <Card>
          ...
          <CardContent className="flex items-center justify-between">
            ...
            <StatusIndicator 
              ...
              label={currentStatus === "normal" ? "Normal" : currentStatus === "warning" ? "Warning" : "Critical"} 
            />
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <Bar dataKey="min" name="Min Current" fill="hsl(var(--chart-2))" />
                <Bar dataKey="max" name="Max Current" fill="hsl(var(--chart-1))" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center p-4 border rounded-lg">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Optimal operating range</p>
            </div>
            <div className="flex flex-col items-center p-4 border rounded-lg">
              <StatusIndicator status="warning" label="Warning" size="lg" />
              <p className="mt-2 text-sm text-muted-foreground">5A - 10A or 30A - 35A</p>
            ...
            <div className="flex flex-col items-center p-4 border rounded-lg">
              ...
              <p className="mt-2 text-sm text-muted-foreground">&lt; 5A or &gt; 35A</p>
