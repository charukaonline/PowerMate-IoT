...
const DeviceInfoCard = ({ data, index }) => {
    ...
    return (
        ...
        >
            <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-700">
                <h3 className="text-base font-bold text-indigo-600 dark:text-indigo-400">Device Information</h3>
            </div>
            ...
            {data ? (
                <div className="p-3 space-y-2">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <div className="text-sm font-semibold text-gray-800 dark:text-gray-200">{formattedDeviceId}</div>
                        </div>
                    </div>

                    <div className="flex items-center pt-1 border-t border-gray-100 dark:border-gray-700">
                ...
                <div className="p-4 flex flex-col items-center justify-center">
                    <AlertTriangle className="h-6 w-6 text-gray-300 dark:text-gray-600 mb-1" />
                    <p className="text-xs text-gray-400 dark:text-gray-500 text-center">No device information available</p>
                </div>
            )}
        </motion.div>
    );
...
const VoltageCard = ({ data, index }) => {
    ...
    return (
        <motion.div
            ...
            className="rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
        >
            <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-700">
                <h3 className="text-base font-bold text-blue-600 dark:text-blue-400">Voltage</h3>
            </div>

            {data ? (
                <div className="p-3">
                    <div className="flex items-center mb-2">
                        <Battery className="h-8 w-8 text-blue-500 dark:text-blue-400 mr-3" />
                        <div className={`text-2xl font-bold ${getVoltageColor(data.voltage)}`}>
                ...
                <div className="p-4 flex flex-col items-center justify-center">
                    <AlertTriangle className="h-6 w-6 text-gray-300 dark:text-gray-600 mb-1" />
                    <p className="text-xs text-gray-400 dark:text-gray-500 text-center">No voltage data available</p>
                </div>
            )}
        </motion.div>
    );
...
const CurrentCard = ({ data, index }) => {
    ...
    return (
        <motion.div
            ...
            className="rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
        >
            <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-700">
                <h3 className="text-base font-bold text-amber-600 dark:text-amber-400">Current</h3>
            </div>

            {data ? (
                <div className="p-3">
                    <div className="flex items-center mb-2">
                        <Zap className="h-8 w-8 text-amber-500 dark:text-amber-400 mr-3" />
                        <div className={`text-2xl font-bold ${getCurrentColor(data.current)}`}>
                ...
                <div className="p-4 flex flex-col items-center justify-center">
                    <AlertTriangle className="h-6 w-6 text-gray-300 dark:text-gray-600 mb-1" />
                    <p className="text-xs text-gray-400 dark:text-gray-500 text-center">No current data available</p>
                </div>
            )}
        </motion.div>
    );
    ...
    return (
        ...
        >
            <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
                <h3 className="text-base font-bold text-gray-400 dark:text-gray-500">{title}</h3>
            </div>
            <div className="p-3 flex flex-col items-center justify-center py-4">
                <AlertTriangle className="h-6 w-6 text-gray-300 dark:text-gray-600 mb-1" />
    ...
    return (
        <div className="max-w-6xl mx-auto p-4 text-gray-900 dark:text-gray-100">
            <motion.h2
                ...
                className="text-xl font-bold mb-4 text-center bg-gradient-to-r from-green-600 to-blue-600 dark:from-green-400 dark:to-blue-400 bg-clip-text text-transparent"
            >
            ...
            {loading ? (
                <div className="flex justify-center items-center py-8">
                    <div className="animate-spin rounded-full h-10 w-10 border-4 border-gray-200 dark:border-gray-700 border-t-green-500 dark:border-t-green-400"></div>
                </div>
            ) : (
