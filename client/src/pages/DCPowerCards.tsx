      ...
      {data ? (
        <div className="p-3">
          <div className="flex items-center mb-2">
            ...
            <div
              className={`text-2xl font-bold ${getVoltageColor(data.voltage)}`}
            >
          ...
          <div className="space-y-1">
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden relative">
              <motion.div
                ...
                animate={{
                  width: showProgress
                    ? `${Math.min(100, (data.voltage / 15) * 100)}%`
                    : 0,
                }}
                transition={{
                  duration: 1.5,
              ...
              {!showProgress && (
                <div
                  className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-200 dark:via-blue-700 to-transparent animate-shimmer"
                  style={{
      ...
      {data ? (
        <div className="p-3">
          <div className="flex items-center mb-2">
            ...
            <div
              className={`text-2xl font-bold ${getCurrentColor(data.current)}`}
            >
          ...
          <div className="space-y-1">
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden relative">
              <motion.div
                ...
                animate={{
                  width: showProgress
                    ? `${Math.min(100, (data.current / 2) * 100)}%`
                    : 0,
                }}
                transition={{
                  duration: 1.5,
              ...
              {!showProgress && (
                <div
                  className="absolute inset-0 bg-gradient-to-r from-transparent via-amber-200 dark:via-amber-700 to-transparent animate-shimmer"
                  style={{
                    backgroundSize: "200% 100%",
                    animation: "shimmer 1.5s infinite",
                  }}
  ...
  return (
    ...
    >
      <div className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
        <h3 className="text-base font-bold text-gray-400 dark:text-gray-500">
          {title}
        </h3>
      </div>
