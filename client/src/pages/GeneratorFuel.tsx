...
const GeneratorFuel = ({ deviceId = "88:13:BF:0C:3B:6C" }) => {
    ...
    switch (filter) {
      ...
      case "7d":
        ...
        filteredData = data.filter(
          (item: any) => item.timestamp >= sevenDaysAgo
        );
        break;
      case "30d":
  ...
  const getWaterColor = (level: number | null) => {
    ...
    if (level <= 20)
      return darkMode ? "from-red-500 to-red-400" : "from-red-600 to-red-500";
    if (level <= 50)
      return darkMode
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h2
          className={`text-2xl font-extrabold bg-gradient-to-r from-blue-500 via-green-400 to-yellow-400 bg-clip-text text-transparent drop-shadow-lg ${theme.text}`}
        >
          Generator Fuel Monitor
        </h2>
      ...
      {loading ? (
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            >
              <p className={`text-sm mb-1 ${theme.subtext}`}>
                Current Fuel Level
              </p>
              <div className="flex items-center justify-between">
                ...
                <div className="relative w-20 h-24 border-2 rounded-lg overflow-hidden">
                  ...
                  <div className="absolute inset-0 overflow-hidden">
                    {/* Main fluid body */}
                    <motion.div
                      className={`absolute left-0 right-0 bottom-0 bg-gradient-to-b ${getWaterColor(
                        currentFuel
                      )}`}
                      initial={{ height: "0%" }}
                  ...
                  {[25, 50, 75].map((level) => (
                    <div
                      key={level}
                      className={`absolute w-2 h-px left-0 ${
          ...
          <div className="mb-4 flex justify-between items-center">
            ...
            <DropdownMenu>
              ...
              >
                {
                  filterOptions.find((option) => option.value === timeFilter)
                    ?.label
                }
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Legend
                  ...
                  iconType="circle"
                  formatter={(value) => (
                    <span style={{ color: darkMode ? "#F3F4F6" : "#374151" }}>
                      {value}
                    </span>
                  )}
                />
          ...
          <div
            className={`mt-6 pt-4 border-t ${theme.border} transition-colors duration-300`}
          >
            <AnimatePresence>
              ...
              {currentFuel !== null && currentFuel <= 20 && (
                ...
                >
                  ...
                  <p className="text-sm">
                    Generator fuel level is critically low. Please refill soon.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
