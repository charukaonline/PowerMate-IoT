...
// POST - Store all sensor data in a single request
const storeSensorData = async (req, res) => {
  try {
    ...
    if (req.body.temperature) {
      try {
        const temperatureData = processTemperatureData(req.body.temperature);
        ...
        results.temperature = { success: true, data: temperatureRecord };
      } catch (error) {
